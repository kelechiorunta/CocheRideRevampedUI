...
export default function AboutHeader() {
  ...
  return (
    <header ref={headerRef}
    className='header_container bg-white fixed top-0 z-50 text-black border-white flex items-center justify-between 
     shadow-md w-full px-[50px] pt-6 pb-6 sm:max-mainheader_breakpoint_four:gap-x-[50px] md:max-xl:gap-x-[50px] xl:max-2xl:gap-x-[50px] xsm:max-sm:px-[50px] '>
        <Link href='/'>
            <Image className='max-w-[100px] h-10 min-w-[70px] ' src={logo} alt='logo'/>
        </Link>
        <div className='flex items-center space-x-8 w-full justify-between xsm:max-lg:hidden'>
            <nav className='relative flex items-center justify-between md:max-xl:mr-[0] space-x-4 xl:max-2xl:space-x-4 '>
                <Link className='xsm:max-mainheader_breakpoint_five:hidden' href='/about'>About Us</Link>
                <Link className='xsm:max-mainheader_breakpoint_five:hidden' href='/move-goods'>Move Goods</Link>
                ...
                <Link className='xsm:max-mainheader_breakpoint_three:hidden' href='#'>Contact Us</Link>
            </nav>
        ...
        <div onClick={toggleMenu}
            className=" hamburger-icon flex space-x-2 text-black mainheader_breakpoint_one:max-2xl:hidden">
            ...
            <div className={`absolute ${isOpen? 'slidemenu': 'close'} menu`}>
              <ul className='p-8 bg-[rgba(255,255,255)] text-black flex gap-8 flex-col items-end 
              top-20 -left-10 w-[300px] h-[600px] shadow-sm text-left rounded-xl transition-all'>
                ...
                <Link className='hidden xsm:max-mainheader_breakpoint_five:block'href='/transporters'>Transporters</Link>
                <Link className='hidden xsm:max-mainheader_breakpoint_four:block' href='#'>Resources</Link>
                <Link className='hidden xsm:max-mainheader_breakpoint_three:block' href='#'>About Us</Link>
